    ...
    const responses = [
      {
        keywords: ['intro', 'introduction', , 'who are you','about the shakeel','Who are you','Can you tell me about yourself','tell me about yourself',
          'Can you introduce yourself','who','about','shakeel'
        ],
...
},
{
  ...
  reply: "During my training at IGO Solutions, I received a stipend of **2500 AED**. I am now looking for a full-time role with a salary in the range of 5000–8000 AED, depending on the responsibilities and growth opportunities."
},
      {
    ...
    for (const res of responses) {
      if (res.keywords.some(keyword => normalized.includes(keyword))) {
